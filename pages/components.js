        ...
        <Box width={"100%"}>
          <Flex width={"100%"} mt={5}>
            ...
            <Box >
              ...
              <Box>
                <Text fontWeight={700}>Code postal : </Text>
                <Input
              ...
              <Box>
                <Text fontWeight={700}>Ville : </Text>
                <Input
          ...
          <Flex gap={4}>
          <Box mb={5}>
            <Text mb={2}  fontWeight={700}>De</Text>
            <Flex>
              <Select
              minW={"22rem"}
              W={"10rem"}
          ...
          <Box mb={5}>
            <Text mb={2}  fontWeight={700}>A</Text>
            <Flex>
              <Select
              minW={"22rem"}
              W={"10rem"}
          ...
          <Box justify={"center"} alignItems={"center"} gap={4} textAlign={"center"}>
            <Text fontWeight={700} fontSize={{base:'xl',lg:"2xl"}}>Reception du colis par la structure : </Text>

            <Flex justifyContent={"center"} alignItems={"center"} my={5}>
              <RadioGroup onChange={setRadio2} value={radio2} display={"flex"} gap={4}>
              
                  <Radio value="Dépôt en agence"  w={"1rem"} h={"1rem"} color={"rgb(13 148 136)"} bgColor={" rgb(243 244 246)"} mr={5}>
                    Dépôt en agence
                  </Radio>
                  <Radio value="Retrait à domicile" w={"1rem"} h={"1rem"} color={"rgb(13 148 136)"} bgColor={" rgb(243 244 246)"}>Retrait a domicile</Radio>
              ...
              >
                ...
                >
                  {categorie.map((data, indexe) => {
                    if (data.contenu == "Ordinateur portable") {
                      PrixPc = PrixPc + 50
                      ...
                      //   if(categorie[index].contenu != "Ordinateur portable"){
