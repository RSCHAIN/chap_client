...
export default function Epicerie (data){
    ...
    data.data.map((datos,index)=>{
        if (datos.data().categorie== "Epicerie" ) {
            if (check == 0 ) {
                setCheck(check+1)
    ...
    return(
        <>
            ...
            onClick={() => {
                ...
                localStorage.setItem("service", "Epicerie");
              
            }}
            _hover={{ textDecoration: "none" }}
          > <Button mr={10} bgColor={"white"} _hover={{bgColor:"white"}} >voir plus <ArrowForwardIcon/> </Button></Link>
                        </Flex>
