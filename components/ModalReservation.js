...
export default function Modaliser({ data, jour }) {
    ...
    pt={7}
                ...
                >
                        ...
                        <Text fontSize={["10px","10px","10px","15px","15px"]} color={"green"}>
                            Ouvert de  {Object.values(data.horaire)[parseInt(jour.getDay())]}
                        </Text>
                    
                </Box>
                <Box>
                    <Text fontSize={["12px","12px","12px","20px","20px"]} pb={2} align={"center"}>
                        {data.adresse}
                    </Text>
                </Box>
            </Box>
