      ...
      <Container as={Stack} maxW={'full'} py={10}>
        <SimpleGrid
          ...
          <Stack align={'flex-start'}>
            ...
            <Link href={'chapbackofficefournisseur.vercel.app'}  target="_blank">Devenir Fournisseur</Link>
            <Link href={'https://chapbackofficelivreur-regz6oep6-josiassehi-rschainnet.vercel.app/'}  target="_blank">Devenir Livreur</Link>
          </Stack>
          <Stack align={'flex-start'}>
