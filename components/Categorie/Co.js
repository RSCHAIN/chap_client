...
//// fonctions pour display les etoiles des feedbacks en fonction du id
...
export default function Co({categorie,magasin}){
    ...
    return(
        ...
        <Box display={["none", "none", "none", "grid", "grid"]} ml={["3%", "3%", "3%", "10%", "10%"]} >
         ...
         <Box>
           ...
           <Text>Retours : Retours refusés / Retours acceptés</Text>
           <Center > 
               <Box>
               <Box mt={5}>
                 <Button
       ...
       <Box display={"grid"} width={"100%"}>
            ...
            <>
              ...
              <SimpleGrid columns={[2, 2, 3,3, 5]} >
                  {data.map((dat, key) => (
                    ...
                    onClick={()=>{
                      secureLocalStorage.setItem("items",dat)
                    ...
                    >
                      ...
                      >
                        <Image
                          ...
                          maxW={["130px","200px","200px","200px","200px"]}
                          // borderRadius={"25px"}
                        />
                      </Box>
                      ...
                      <Box >
                        ...
                        >
                          ...
                          {dat.duree == "Expedié en 24h" ? <Text className={"Exp"} my={2}>Livré le {dateExp3} </Text> : <Text  className={"Exp"}my={2}>Livré le {dateExp6} </Text>}
                          <Flex>
                            <Box mt={2}>
                            <BsCashCoin />
                            </Box>
        ...
        <Box>
          <Text>Liste de produits pouvant vous interessé</Text>
          <Favlist2/>
        </Box>
        <FooterR />
      </>
