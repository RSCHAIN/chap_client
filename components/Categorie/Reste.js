...
export default function Reste(){
    ...
    const [donneeId, setDonneId] = useState([]);
              ...
              <SimpleGrid columns={[2, 2, 3,3, 5]} >
                  {data.map((data, key) => (
                    ...
                    onClick={()=>{
                      ...
                      secureLocalStorage.setItem("i",donneeId[key])
                    }}>
                     <Box 
                    mx={5}
                      key={data.id}
                    ...
                    >
                      ...
                      <Box >
                        ...
                        >
                          <Box width={"100%"} >
                          <Text  width={["150px","190px","190px","200px","200px"]} height={"3vh"} noOfLines={3}  fontSize={"15px"} my={2}>
                            {data.nom}
                          </Text>
                          <Box mb={2}>
